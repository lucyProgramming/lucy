...
func main() {
	...
	flag.BoolVar(&common.CompileFlags.DisableCheckUnUse, "disable-check-unuse", false, "disable check un use")
	flag.StringVar(&common.CompileFlags.PackageName, "package-name", "", "package name")
	flag.IntVar(&common.CompileFlags.JvmMajorVersion, "jvm-major-version", 52, "jvm major version")
