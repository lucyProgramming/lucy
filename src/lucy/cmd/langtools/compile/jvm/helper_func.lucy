...
func newArrayBaseOnType(class *cg.ClassHighLevel, code *cg.AttributeCode, typ *ast.Type) {
	...
	case ast.VariableTypeJavaArray:
		code.Codes[code.CodeLength] = cg.OP_anewarray
		class.InsertClassConst(Descriptor.typeDescriptor(typ.Array),
...
func setEnumArray(class *cg.ClassHighLevel, code *cg.AttributeCode,
	state *StackMapState, context *Context, e *ast.Enum) (maxStack uint16) {
	if e.DefaultValue == 0 {
		return
	}
	type autoVar = struct {
